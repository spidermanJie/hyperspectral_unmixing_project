%% Name: geo_unmixing_m008
%
%   Generate the pure pixel unmixing results for section IV, Fig 15, 
%   bottom-left
%  
%   Data sets: 
%   SusgsP5MP08SNR30 -> P = 5, max purity = 0.8, SNR = 30 dB
%
