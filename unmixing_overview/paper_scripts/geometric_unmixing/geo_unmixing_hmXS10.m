%% Name: geo_unmixing_hmX10
%
%   Generate the pure pixel unmixing results for section IV, Fig 15,top-left
%  
%   Data sets: 
%   SusgsP5XS10SNR30 -> P = 5,  Dirochlet parameter = 10 (highly mixed), 
%   SNR = 30 dB
%
